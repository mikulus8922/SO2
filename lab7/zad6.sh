...
# wypisz include graphics; usun pierwszy nawias "}";
# przepisz tekst od konca; usun pierwszy nawias "{"; napraw tekst
grep "\\fbox.*\\includegraphics" dodatkowe/slajdy.tex | sed "s/}.*//g" | rev | sed "s/{.*//g" | rev
